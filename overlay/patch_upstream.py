...
def main():
    ...
    # 2. Lås opp MAX_NUM_SEQS i vllm_generator.py
    ...
    if vg_path.exists():
        ...
        # Lås opp temperature, top_p, etc i _generate_async
    ...
    # Oppdater kallene til generatoren (begge steder)
    ...
    # Fix WAV output for Home Assistant
